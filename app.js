...
function registarDespesa() {
    ...
    if (despesa.validarDados()) {
        ...
        document.getElementById('modalBody').innerHTML = 'A despesa foi adicionada à lista com sucesso.'
        ...
        document.getElementById('modalTitulo').innerHTML = 'Erro na inclusão do registo'
